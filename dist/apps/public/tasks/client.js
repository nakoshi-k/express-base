...
var vuex_router_sync_1 = __webpack_require__(33);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_99f0819c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(11);
var disposed = false
...
Object.defineProperty(exports, "__esModule", { value: true });
var vue_1 = __webpack_require__(0);
var vue_router_1 = __webpack_require__(13);
var Navi_vue_1 = __webpack_require__(14);
var Page_vue_1 = __webpack_require__(16);
var Sub_vue_1 = __webpack_require__(23);
var Add_vue_1 = __webpack_require__(26);
var Interface_1 = __webpack_require__(4);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Page_vue__ = __webpack_require__(17);
...
Object.defineProperty(exports, "__esModule", { value: true });
var vue_1 = __webpack_require__(0);
var vuex_1 = __webpack_require__(5);
var vue_class_component_1 = __webpack_require__(2);
...
var Pagintaion = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Pagintaion.prototype, "last", {
        get: function () {
            var last = this.pagination.totalPage;
    ...
    Pagintaion.prototype.number = function (numbers) {
      ...
      [
        _vm.show.first
          ? _c(
              ...
              { on: { click: _vm.move } },
              [
                _c("router-link", { attrs: { to: _vm.first } }, [
                  _vm._v("first")
                ])
              ],
              1
        ...
        _vm.show.prev
          ? _c(
              ...
              { on: { click: _vm.move } },
              [
                _c("router-link", { attrs: { to: _vm.prev } }, [_vm._v("prev")])
              ],
              1
            )
          : _vm._e(),
        ...
        _vm.show.next
          ? _c(
              ...
              { on: { click: _vm.move } },
              [
                _c("router-link", { attrs: { to: _vm.next } }, [_vm._v("next")])
              ],
              1
            )
          : _vm._e(),
        ...
        _vm.show.last
          ? _c(
              ...
              { on: { click: _vm.move } },
              [
                _c("router-link", { attrs: { to: _vm.last } }, [_vm._v("last")])
              ],
              1
            )
          : _vm._e()
...
var vue_1 = __webpack_require__(0);
var vue_class_component_1 = __webpack_require__(2);
var flatpickr = __webpack_require__(28);
var confirmDatePlugin = __webpack_require__(29);
vue_class_component_1.default.registerHooks([
    'beforeRouteEnter',
    'beforeRouteLeave',
    'asyncData',
...
var Add = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Add.prototype, "token", {
        get: function () {
...
function createStore(options) {
    ...
    var actions = {
        fetchEntities: function (_a, query) {
            ...
            return api.paginate(query).then(function (paginate) {
...
var Internal = /** @class */ (function () {
    function Internal(options) {
        ...
        this.paginate = function (query) {
            if (query === void 0) { query = { page: 1, search: "" }; }
            var url = "/" + _this.entities_name + "/page/" + query.page + query.search;
            if (typeof window === "undefined") {
        ...
        this.entity = function (query) {
            if (query === void 0) { query = { page: 1, search: "" }; }
            var url = "/" + _this.entity_name + "/page/" + query.page + query.search;
            if (typeof window === "undefined") {
                return _this.server(url, {});
            }
            return _this.client(url, {});
