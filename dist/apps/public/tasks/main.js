...
var sub_vue_1 = __webpack_require__(16);
...
var Foo = { template: sub_vue_1.default };
var Bar = { template: '<div>bar</div>' };
var routes = [
    { path: '/tasks/', component: index_vue_1.default },
    { path: '/tasks/foo', component: Foo },
    { path: '/tasks/bar', component: Bar }
];
...
var vue_1 = __webpack_require__(2);
var vue_class_component_1 = __webpack_require__(6);
var pagination_helper_1 = __webpack_require__(12);
var pagintaion = /** @class */ (function (_super) {
    __extends(pagintaion, _super);
    function pagintaion() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.p = new pagination_helper_1.pagination_helper();
        return _this;
    }
    pagintaion.prototype.mounted = function () {
        this.load();
    };
    pagintaion.prototype.load = function () {
        //p.render({});
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var tag_helper_1 = __webpack_require__(13);
...
var pagination_helper = /** @class */ (function (_super) {
    ...
    function pagination_helper() {
        ...
        _this.tag = new tag_helper_1.tag_helper();
...
var tag_helper = /** @class */ (function (_super) {
    ...
    function tag_helper() {
        ...
        _this.wrap = function (tagName, content, attr) {
            ...
            var tag = "\n                " + _this.create(tagName, attr) + "\n                    " + content + "\n                " + _this.create("/" + tagName) + "  \n            ";
            return tag;
        };
        return _this;
    }
...
var render = function() {
  ...
  return _c("div", { domProps: { innerHTML: _vm._s(_vm.page()) } })
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "index", class: _vm.size },
    [
      _vm._l(_vm.rows, function(row) {
        return _c("div", [
          _c("a", { attrs: { href: _vm.view(row.id) } }, [
            _vm._v(_vm._s(row.title))
          ])
        ])
      }),
      _vm._v(" "),
      _c("pagination", { attrs: { pagination: _vm.page } })
    ],
    2
  )
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sub_vue__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7aa5ce5c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_sub_vue__ = __webpack_require__(18);
var disposed = false
var normalizeComponent = __webpack_require__(5)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7aa5ce5c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_sub_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "apps/tasks/vue/sub.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7aa5ce5c", Component.options)
  } else {
    hotAPI.reload("data-v-7aa5ce5c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "sub", class: _vm.size },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7aa5ce5c", esExports)
  }
}
