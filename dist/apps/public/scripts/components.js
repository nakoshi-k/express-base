...
var confirmDatePlugin = __webpack_require__(3);
var umbrellajs_1 = __webpack_require__(4);
global["u"] = umbrellajs_1.u;
flatpickr(".calendar", {
    "enableTime": true,
    "plugins": [new confirmDatePlugin({})]
});
var remodal = __webpack_require__(5);
var xhrPost = /** @class */ (function () {
    function xhrPost(selector) {
        var _this = this;
        this.getMethod = function (form) {
            var method = form.children('[name="_method"]').attr("value");
            if (method === "") {
    ...
    Object.defineProperty(xhrPost.prototype, "success", {
        set: function (func) {
            this._success = func;
        },
        enumerable: true,
    ...
    Object.defineProperty(xhrPost.prototype, "faild", {
        set: function (func) {
            this._faild = func;
        },
        enumerable: true,
    ...
    Object.defineProperty(xhrPost.prototype, "error", {
        set: function (func) {
            this._error = func;
        },
        enumerable: true,
