(function (e, a) { for (var i in a)
        ...
        var render = function () {
            ...
            return _vm.modal
                ? _c("div", {
                    ...
                    _vm._ssrNode('<div class="modal"><div class="text-right"><span class="typcn typcn-delete large"></span></div> <div class="content">\n      モーダル\n    </div></div>')
                ])
                : _vm._e();
        };
        var staticRenderFns = [];
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var render = function () {
            ...
            var _c = _vm._self._c || _h;
            return _c("div", { staticClass: "resource column column-75" }, [
                _vm._ssrNode('<h2>Add</h2> <form action="./" method="post"><input type="hidden" name="_csrf" placeholder="title"' +
