 ...
 * router loading
 */
const router_1 = require("./apps/tasks/router");
const router_2 = require("./apps/users/router");
/**
 * main
 */
class main {
    constructor() {
        ...
        this.router = (app) => {
            app.use("/tasks", new router_1.router("/tasks"));
            app.use("/users", new router_2.router("/users"));
        };
